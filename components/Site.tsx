...
export function SiteNav() {
  return (
    <header className="topbar"><div className="container nav">
      <Wordmark />
      <nav className="links"><a href="/">Начало</a><a href="/order">Продукти</a><a href="/#how">Как работи</a><a href="/#about">За нас</a><a href="mailto:hello@petalapa.com">Контакт</a></nav>
      <div className="navr"><a href="/order" className="icbtn" aria-label="Търсене"><Ic d={I.search} /></a><a href="/dashboard" className="icbtn" aria-label="Профил"><Ic d={I.user} /></a><a className="btn btn-primary btn-sm" href="/order">Създай таг</a></div>
    </div></header>
  );
}
export function SiteFooter() {
  return (
    <footer className="site-footer"><div className="container">
      ...
      <span className="copy">© 2026 PetaLapa. Всички права запазени.</span>
    </div></footer>
  );
}
